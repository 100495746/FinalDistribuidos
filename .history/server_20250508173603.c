...
cada cliente que se conecte:
	1.	Envíe un comando (por ejemplo "REGISTER")
	2.	El servidor lo lea desde el socket (read())
	3.	Procese ese comando (empezamos por "REGISTER")
	4.	Responda con un código: 0 (OK), 1 (USERNAME IN USE), 2 (ERROR)
*/
