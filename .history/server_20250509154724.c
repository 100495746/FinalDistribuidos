...
void *handle_client(void *arg) {
    ...
    ssize_t read(int fd, void *buf, size_t count); 
        fd: el socket (ej. cliente_sd)
        •	buf: el espacio donde guardarás lo leído
        •	count: cuántos bytes máximo quieres leer

    Devuelve:
        •	Número de bytes leídos, o
        •	0 si el cliente cerró la conexión, o
        •	-1 si hubo error
   ...
   if (strcmp(comando, "REGISTER") == 0) {
        ...
        write(cliente_sd, &resubueno, yltado, sizeof(resultado));
   }
